...
class ImageView extends StatefulWidget {
  ...
  ImageView({required this.imgUrl,required this.imgUrlLarge,required this.wallpapers});
...
class _ImageViewState extends State<ImageView> {
                  ...
                  menuItems: [
                    ...
                    FocusedMenuItem(
                        ...
                        onPressed: () {
                          isWallpaperSet ? setState(() {
                            _wallpaper = 'Already Set';
                          }) : _setWallpaper(WallpaperManager.BOTH_SCREENS);
                    }),
                  ],
                  onPressed: () {},
                  child: Stack(
  ...
  _shareImageLink() {
    ...
    kIsWeb ? Share.share(widget.imgUrlLarge,subject: 'Share Wallpaper Link') : Share.share(widget.imgUrl,subject: 'Share Wallpaper Link');
  ...
  Future<void> _setWallpaper(int wallpaperType) async {
    ...
    if(kIsWeb){
      ...
      try{
        result = await WallpaperManager.setWallpaperFromFile(file.path, wallpaperType);
  ...
  _showAlertDialog(String query) {
    ...
    CupertinoAlertDialog alertDialog = CupertinoAlertDialog(
      ...
      content: Text('You can not set wallpaper for $query. Download the image and set wallpaper manually.'),
    );
